...
SVR_CRT="../certs/servers/routeplanner/routeplanner.crt"
SVR_KEY="../certs/servers/routeplanner/routeplanner.key"
...
def route_planner():
    print("For debugging purposes: Yes, they are sending in adresses.")
